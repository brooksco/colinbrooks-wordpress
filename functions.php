...
if (!function_exists('colinbooks_setup')) :
    /**
    ...
    function colinbooks_setup() {
         ...
         * If you're building a theme based on colinbooks, use a find and replace
         * to change 'colinbooks' to the name of your theme in all the template files.
         */
        load_theme_textdomain('colinbooks', get_template_directory() . '/languages');
        ...
        add_theme_support('custom-background', apply_filters('colinbooks_custom_background_args', array(
...
add_action('after_setup_theme', 'colinbooks_setup');
...
function colinbooks_content_width() {
    ...
    $GLOBALS['content_width'] = apply_filters('colinbooks_content_width', 640);
}

add_action('after_setup_theme', 'colinbooks_content_width', 0);
...
function colinbooks_widgets_init() {
    register_sidebar(array(
        ...
        'id' => 'sidebar-1',
        'description' => esc_html__('Add widgets here.', 'colinbooks'),
...
add_action('widgets_init', 'colinbooks_widgets_init');
