        ...
        const p5Lines = new p5(function (p) {
            ...
            function particle(x, y) {
                ...
                this.move = function () {
                    ...
                    const changeAngle = p.noise(
                        this.position.y / 200,
                        this.position.x / 200) * p.TWO_PI;
                        
                        const dynamicChangeAngle = p.noise(
                            p.frameCount / this.changeSpeed,
                            p.frameCount / this.changeSpeed) * p.TWO_PI;
                            
                            this.direction.x = p.cos(angle + changeAngle + dynamicChangeAngle * 2);
                            this.direction.y = p.sin(angle + changeAngle + dynamicChangeAngle * 1.5);
                        ...
                        this.draw = function () {
                            const noiseColorVal = p.noise(this.position.x / 400, this.position.y / 400);
